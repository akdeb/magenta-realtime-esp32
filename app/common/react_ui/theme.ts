  ...
  components: {
    ...
    MuiMenuItem: {
      styleOverrides: {
        root: {
          '&.Mui-selected': {
            backgroundColor: 'var(--color-menu-selected, rgba(255, 255, 255, 0.15)) !important',
            '&:hover': {
              backgroundColor: 'var(--color-menu-selected-hover, rgba(255, 255, 255, 0.25)) !important',
            },
          },
          '&:hover': {
    ...
    MuiButton: {
      ...
      styleOverrides: {
        root: {
          ...
          color: 'var(--color-fg, rgba(255, 255, 255, 0.9))',
          fontSize: '12px',
          fontWeight: 500,
          padding: '6px 16px',
          border: 'none',
          boxShadow: 'none',
          '&:hover': {
            backgroundColor: 'var(--color-hover, #444649)',
