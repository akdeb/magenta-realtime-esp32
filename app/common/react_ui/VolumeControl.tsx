...
export function VolumeControl({
  ...
  const sliderContainerStyle: React.CSSProperties = {
    ...
    borderRadius: '24px',
    padding: '16px 10px',
    boxShadow: '0 8px 24px var(--color-shadow, rgba(0,0,0,0.3))',
    zIndex: 100,
    height: '140px',
    width: '40px',
        ...
        <div style={{
          ...
          <input
            ...
            style={{
              ...
              height: '6px',
              borderRadius: '3px',
              background: `linear-gradient(to right, var(--color-fg, #ffffff) ${linearVol * 100}%, var(--color-border, rgba(255, 255, 255, 0.2)) ${linearVol * 100}%)`,
              outline: 'none',
          ...
          <style>{`
            .volume-slider-input[type="range"]::-webkit-slider-thumb {
              ...
              box-shadow: 0 2px 6px var(--color-shadow, rgba(0,0,0,0.4));
            }
          `}</style>
        </div>
      </div>
