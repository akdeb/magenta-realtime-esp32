 ...
 * a themed MUI Menu on click. Consumers just provide a label and
 * <MenuItem> children.
 */
  ...
  return (
    <div style={{ display: 'inline-block', verticalAlign: 'baseline' }}>
      ...
      <Menu
        ...
        sx={{
          '& .MuiPaper-root': {
            background: 'var(--color-menu-bg, #2e2e2e)',
            border: 'none',
            borderRadius: '8px',
            color: 'var(--color-menu-fg, #f3f4f6)',
            minWidth: '240px',
            ...menuSx,
          },
          '& .MuiList-root': {
          ...
          '& .MuiMenuItem-root': {
            ...
            height: '45px',
            '&.Mui-selected': {
              backgroundColor: 'var(--color-menu-selected, rgba(255, 255, 255, 0.15))',
              '&:hover': {
                backgroundColor: 'var(--color-menu-selected-hover, rgba(255, 255, 255, 0.25))',
              },
            ...
            '&:hover': {
              backgroundColor: 'var(--color-menu-hover, rgba(255, 255, 255, 0.08))',
            },
            '&:has(.MuiIconButton-root:hover):hover': {
